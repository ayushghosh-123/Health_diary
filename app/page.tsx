    ...
    <nav className="border-b border-slate-200 bg-white/80 backdrop-blur-md sticky top-0 z-20 shadow-sm">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-extrabold text-xl text-slate-800 tracking-tight">Health Diary</span>
        </Link>
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-rose-50 to-slate-50">
      ...
      <section className="text-center px-6 pt-24 pb-32 sm:pt-32 sm:pb-48 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            Stress, sleep, or nutrition — Health Diary helps you connect the dots between your daily actions and your long-term health, building a truly balanced life.
          </motion.p>
      ...
      <section className="bg-slate-50/70 py-24 px-6">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-4xl mx-auto text-lg">
              Health Diary moves beyond simple notes. It turns reflection into actionable insight, helping you preempt stress and cultivate lasting well-being.
            </p>
          </div>
      ...
      <section className="py-24 px-6 bg-rose-50/70">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-4xl mx-auto text-lg">
                See what others are saying about finding clarity and balance with Health Diary.
            </p>
          </div>
